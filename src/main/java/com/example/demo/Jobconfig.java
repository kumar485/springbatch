...
public class Jobconfig {
	...
	@Bean
	public FlatFileItemReader<Person> readPerson(){
	...
	@Bean
	public JdbcBatchItemWriter<Person> writePerson(){
	...
	@Bean
	public Processor processPerson(){
	  ...
	  @Bean
	    public Job importUserJob(JobExecutionFinisher listener) {
	        return jbf.get("importUserJob")
